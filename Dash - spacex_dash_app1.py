...
app.layout = html.Div(children=[
    ...
    dcc.RangeSlider(
        ...
        marks={0: '0', 10000: '10000'},  # Updated max mark to match max_payload
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_df, 
                    names='class',  # Each slice now represents success (1) vs failure (0) for that specific site
...
#Which payload range(s) has the lowest launch success rate? 6-8K
